...
/** Inline section — matches /contact */
      ...
      <div className="mx-auto max-w-6xl px-6 md:px-10">
        <div className="grid gap-14 lg:grid-cols-12 lg:gap-16">
          <div className="lg:col-span-5">
            ...
            <h2
              className="mb-6 text-3xl font-light leading-tight md:text-4xl"
            ...
            >
              Share your ideas and preferred dates — I read every message and reply as soon as I can.
            </p>
            <dl
            ...
            >
              {sent ? (
                ...
                >
                  ...
                  <div>
                    <label
                      htmlFor="section-contact-datetime"
                      className="mb-2 block text-[10px] tracking-[0.28em] uppercase"
                      style={{ fontFamily: "var(--font-sans)", color: MUTED }}
                    >
                      Preferred date / time
                  ...
                  <div>
                    <label
                      htmlFor="section-contact-booking"
                      className="mb-2 block text-[10px] tracking-[0.28em] uppercase"
                      style={{ fontFamily: "var(--font-sans)", color: MUTED }}
                    >
